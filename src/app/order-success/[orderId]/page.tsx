  ...
  return (
    <div className="container mx-auto px-4 py-16 text-center">
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <p className="text-gray-600 mb-2">{t('orderId', language)}: {params.orderId}</p>
        <p className="text-gray-600 mb-8">Total: ₹{mockOrder.total.toFixed(2)}</p>

        <div className="space-y-3">
          <button
            onClick={() => generateInvoicePDF(mockOrder)}
            className="w-full bg-primary text-white py-3 rounded-lg hover:bg-red-600 font-bold transition"
          >
